...
bool Core::find_functions()
{
	...
	if ( ByondBuild > 1589 )
	{
		...
		FIND_OR_DIE(CallProcByName, "55 8B EC 6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 83 EC 18 53 56 57 A1 ?? ?? ?? ?? 33 C5 50 8D 45 F4 64 A3 00 00 00 00 8B 75 14 8D 45 F3 8B 5D 10 6A 01 ??");
	}
	else
	{
