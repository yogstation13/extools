...
bool Core::find_functions()
{
	...
	FIND_OR_DIE(SetAppearance, "55 8b ec 8b 45 08 83 ec 08 0f b6 c8 53 8d 41 ff 56 57 83 f8 53 0f 87 e7 03 00 00 0f b6 80 ?? ?? ?? ?? ff 24 85 ?? ?? ?? ?? ff 75 0c ff 75 10 e8 ?? ?? ?? ?? 83 c4 08 5f 5e 5b 8b e5 5d c3");
	FIND_OR_DIE(SetPixelX, "55 8b ec 8b 45 08 56 3c 03 75 16 8b 75 0c 3b 35 ?? ?? ?? ?? 0f 83 88 00 00 00 a1 ?? ?? ?? ?? eb 14 3c 02 75 53 8b 75 0c 3b 35 ?? ?? ?? ?? 73 72 a1 ?? ?? ?? ?? 8b 34 b0 85 f6 74 66 8b 45 10 66 3b 46 32 74 5d 66 89 46 32 ??");
	FIND_OR_DIE(SetPixelY, "55 8b ec 8b 45 08 56 3c 03 75 16 8b 75 0c 3b 35 ?? ?? ?? ?? 0f 83 88 00 00 00 a1 ?? ?? ?? ?? eb 14 3c 02 75 53 8b 75 0c 3b 35 ?? ?? ?? ?? 73 72 a1 ?? ?? ?? ?? 8b 34 b0 85 f6 74 66 8b 45 10 66 3b 46 34 74 5d 66 89 46 34 ??");
	FIND_OR_DIE(SetPixelW, "55 8b ec 8b 45 08 56 3c 03 75 16 8b 75 0c 3b 35 ?? ?? ?? ?? 0f 83 88 00 00 00 a1 ?? ?? ?? ?? eb 14 3c 02 75 53 8b 75 0c 3b 35 ?? ?? ?? ?? 73 72 a1 ?? ?? ?? ?? 8b 34 b0 85 f6 74 66 8b 45 10 66 3b 46 36 74 5d 66 89 46 36 ??");
	FIND_OR_DIE(SetPixelZ, "55 8b ec 8b 45 08 56 3c 03 75 16 8b 75 0c 3b 35 ?? ?? ?? ?? 0f 83 88 00 00 00 a1 ?? ?? ?? ?? eb 14 3c 02 75 53 8b 75 0c 3b 35 ?? ?? ?? ?? 73 72 a1 ?? ?? ?? ?? 8b 34 b0 85 f6 74 66 8b 45 10 66 3b 46 38 74 5d 66 89 46 38 ??");
	FIND_OR_DIE(SetMovableDir, "55 8b ec 6a ff 68 ?? ?? ?? ?? 64 a1 00 00 00 00 50 81 ec d4 01 00 00 a1 ?? ?? ?? ?? 33 c5 89 45 f0 53 56 57 50 8d 45 f4 64 a3 00 00 00 00 8b 45 08 8b 75 0c 89 85 24 fe ff ff 0f b6 c0");
	...
	FIND_OR_DIE(Flick, "55 8b ec 53 56 b8 6c 00 00 00 b9 ?? ?? ?? ?? 57 32 db 66 a3 ?? ?? ?? ?? 33 f6 e8");
	FIND_OR_DIE(Animate, "55 8b ec 81 ec ?? ?? ?? ?? a1 ?? ?? ?? ?? 33 c5 89 45 fc 8b 45 08 8b 55 0c 8b 0d");
	FIND_OR_DIE(InitClient, "55 8b ec 33 c0 b9 ff ff 00 00 53 56 8b 75 0c 83 cb ff 57 8b 7d 08");
	...
	char* delete_client_ptr_ptr = (char*)Pocket::Sigscan::FindPattern(BYONDCORE, "e8 ?? ?? ?? ?? 83 c4 04 66 3b 1d ?? ?? ?? ?? 0f 83 b2 00 00 00 a1 ?? ?? ?? ??", 1);
	DeleteClient = (DeleteClientPtr)(delete_client_ptr_ptr + *(int*)delete_client_ptr_ptr + 4);
	...
	client_table = *(TableHolder2**)((char*)DeleteClient + 90);
